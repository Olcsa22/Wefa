...
public abstract class UIProvider implements Serializable {
    ...
    public String getTheme(UICreateEvent event) {
        ...
        if (uiTheme != null) { 
            String value = uiTheme.value();
            if (value != null && value.equals("#brand")) {
            	return BrandUtil.getBrand(false, true);
            }
            return value;
        } else {
            return null;
    ...
    public WidgetsetInfo getWidgetsetInfo(UICreateEvent event) {
        ...
        if (info != null) {
            ...
            if (resource != null) {
                return new WidgetsetInfoImpl(false, null, APP_WIDGETSET_NAME); // TODO: closable?
            }
        }
    ...
    private Class<WidgetsetInfo> findWidgetsetClass() {
        try {
            ...
            // classloader
            // This might still fail with osgi
